...
if az pipelines variable-group list --query "[?name=='$GROUP_NAME']" -o tsv | grep -q .; then
    ...
    add_variable "$GROUP_NAME" "DEV_API_URL" "https://api-dev.datingapp.com" "false"
    add_variable "$GROUP_NAME" "DEV_WS_URL" "wss://ws-dev.datingapp.com" "false"
    add_variable "$GROUP_NAME" "DEV_URL" "https://dev.datingapp.com" "false"
...
if az pipelines variable-group list --query "[?name=='$GROUP_NAME']" -o tsv | grep -q .; then
    ...
    add_variable "$GROUP_NAME" "STAGING_API_URL" "https://api-staging.datingapp.com" "false"
    add_variable "$GROUP_NAME" "STAGING_WS_URL" "wss://ws-staging.datingapp.com" "false"
    add_variable "$GROUP_NAME" "STAGING_URL" "https://staging.datingapp.com" "false"
    ...
    add_variable "$GROUP_NAME" "TEST_USER_EMAIL" "test@datingapp.com" "false"
...
if az pipelines variable-group list --query "[?name=='$GROUP_NAME']" -o tsv | grep -q .; then
    ...
    add_variable "$GROUP_NAME" "PROD_API_URL" "https://api.datingapp.com" "false"
    add_variable "$GROUP_NAME" "PROD_URL" "https://datingapp.com" "false"
    add_variable "$GROUP_NAME" "PROD_CANARY_URL" "https://canary.datingapp.com" "false"
