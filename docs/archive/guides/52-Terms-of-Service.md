...
We may verify your age and reserve the right to request proof of age.
...
- Spam, scam, or solicit money from other users
...
### Profile Photos
- Photos must be of you and appropriate
- No nudity, violence, or offensive content
- We use AI moderation to screen photos
- Photos may be used for verification purposes

## 5. Safety & Moderation

### Content Moderation
We use automated and manual moderation to:
...
- **Premium**: Unlimited likes, advanced filters, see who liked you
- **Premium+**: All Premium features plus profile boost and virtual coins

### Payment Terms
- Subscriptions auto-renew unless cancelled
- Prices are in USD and may vary by region
- Refunds are processed according to Apple/Google policies
- Cancel anytime through your app store account settings

### Virtual Currency
- Coins can be purchased for special features
- Coins have no cash value and are non-refundable
- Unused coins remain in your account
- Coins are forfeited upon account deletion

## 8. Matching & Interaction

### How Matching Works
- Mutual interest creates a match
- You can like, skip, or super like profiles
- Matches can message each other
- Either user can unmatch at any time
...
- Outcomes of relationships formed through the app
...
We do not conduct background checks on users. You are responsible for your own safety.
...
- We are not liable for user conduct or offline interactions
...
We may update these Terms. We'll notify you of material changes through:
- In-app notification
