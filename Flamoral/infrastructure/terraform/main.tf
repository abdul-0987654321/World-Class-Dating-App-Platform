...
module "cost_management" {
  ...
  compute_monthly_budget    = var.compute_monthly_budget
  storage_monthly_budget    = var.storage_monthly_budget
  networking_monthly_budget = var.networking_monthly_budget
  database_monthly_budget   = var.database_monthly_budget
  ...
  enforce_tagging_policy = local.effective_env == "prod"
...
module "dns" {
  ...
  # AKS configuration for fallback
  aks_ingress_hostname = module.aks.aks_fqdn
