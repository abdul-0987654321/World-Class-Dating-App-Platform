...
// Tier configuration aligned with backend (FREE, BASIC, PLUS, PREMIUM, PREMIUM_PLUS, ELITE)
export const TIER_CONFIG = {
  ...
  PREMIUM: {
    ...
    textColor: '#0E7490',
    gradient: 'linear-gradient(135deg, #06B6D4 0%, #22D3EE 50%, #06B6D4 100%)',
    borderColor: '#22D3EE',
  ...
  ELITE: {
    ...
    textColor: '#9D174D',
    gradient: 'linear-gradient(135deg, #EC4899 0%, #F472B6 25%, #FB7185 50%, #F472B6 75%, #EC4899 100%)',
    borderColor: '#F472B6',
    ...
    >
      ...
      <style>{`
        ...
        .tier-basic {
          ...
          animation: basicShine 3s ease-in-out infinite;
        }
        ...
        .tier-premium {
          background: linear-gradient(135deg, #06B6D4 0%, #22D3EE 50%, #06B6D4 100%) !important;
        ...
        .tier-elite {
          background: linear-gradient(135deg, #EC4899 0%, #F472B6 25%, #FB7185 50%, #F472B6 75%, #EC4899 100%) !important;
        ...
        @keyframes premiumPlusGlow {
          ...
          100% { box-shadow: 0 4px 25px rgba(16, 185, 129, 0.6); }
        }
        ...
        @keyframes eliteShimmer {
          ...
          50% {
            box-shadow: 0 4px 30px rgba(236, 72, 153, 0.7), 0 0 40px rgba(236, 72, 153, 0.5);
          }
        }
      `}</style>
    </button>
  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .tier-card-elite .tier-card-header {
          animation: eliteHeaderShimmer 3s ease-in-out infinite;
        }

        @keyframes eliteHeaderShimmer {
