...
export class CallSignalingService extends EventEmitter {
  ...
  constructor(serverUrl?: string) {
    super();
    // Use provided URL, or fall back to VITE_SOCKET_URL or API URL
    this.serverUrl = serverUrl || import.meta.env.VITE_SOCKET_URL || import.meta.env.VITE_API_URL?.replace('/api/v1', '') || window.location.origin;
    console.log('Call signaling service using server:', this.serverUrl);
  }
