...
export const CheckoutPage: React.FC = () => {
  ...
  const loadPlan = async () => {
    ...
    try {
      const res = await fetch(`/api/v1/subscriptions/plans/${planId}`, {
        credentials: 'include',
      });
                ...
                {paymentMethod === 'mobile' && (
                  <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button type="button" className="p-3 bg-white border border-gray-300 rounded-lg hover:border-green-500 transition">
                        <p className="font-medium">Paystack</p>
                        <p className="text-xs text-gray-500">For African markets</p>
                      </button>
                      <button type="button" className="p-3 bg-white border border-gray-300 rounded-lg hover:border-green-500 transition">
              ...
              <div className="mb-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Billed {plan.interval}</p>
                  </div>
                </div>
              </div>
