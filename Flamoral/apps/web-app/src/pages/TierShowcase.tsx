        ...
        <section className="section">
                ...
                <div key={tier} className="profile-header-example">
                  ...
                  <div className="profile-info">
                    <span className="profile-name">
                      {tier === 'FREE' ? 'Alex' : tier === 'BASIC' ? 'Jordan' : tier === 'PLUS' ? 'Taylor' : tier === 'PREMIUM' ? 'Morgan' : tier === 'PREMIUM_PLUS' ? 'Casey' : 'Riley'}
                    </span>
          ...
          <div className="context-example">
            ...
            <div className="chat-examples">
              {(['BASIC', 'PLUS', 'PREMIUM'] as SubscriptionTier[]).map((tier) => (
                  ...
                  <div className="message-content">
                    <div className="message-header">
                      <span className="message-name">
                        {tier === 'BASIC' ? 'Sarah' : tier === 'PLUS' ? 'Mike' : 'Emma'}
                      </span>
                      <TierIcon tier={tier} size="xs" />
                    </div>
          ...
          <div className="tier-cards-grid">
            {(Object.keys(TIER_CONFIG) as SubscriptionTier[]).map((tier) => (
              <TierCard
                ...
                isCurrentTier={tier === 'BASIC'} // Example: Basic is current
