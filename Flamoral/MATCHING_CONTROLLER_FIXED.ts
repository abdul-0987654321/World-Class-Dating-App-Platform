...
export class MatchingController {
  ...
  async searchProfiles(
    ...
    return this.proxyService.post('matchingService', '/api/search', body, {
      Authorization: authorization,
    });
  }
  ...
  async getNearbyUsers(
    ...
    const path = `/api/search/nearby${queryString.toString() ? '?' + queryString.toString() : ''}`;
    return this.proxyService.get('matchingService', path, {
      Authorization: authorization,
    });
  }
  ...
  async likeProfile(
    ...
    return this.proxyService.post('matchingService', '/api/swipes',
      { ...body, action: 'like' },
      {
        Authorization: authorization,
      }
  ...
  async getLikesReceived(
    ...
    const path = `/api/swipes/likes${queryString.toString() ? '?' + queryString.toString() : ''}`;
    return this.proxyService.get('matchingService', path, {
      Authorization: authorization,
    });
  }
  ...
  async getLikesSent(
    ...
    const path = `/api/swipes/sent${queryString.toString() ? '?' + queryString.toString() : ''}`;
    return this.proxyService.get('matchingService', path, {
      Authorization: authorization,
    });
  }
  ...
  async undoAction(@Headers('authorization') authorization: string) {
    return this.proxyService.post('matchingService', '/api/swipes/undo', {}, {
      Authorization: authorization,
    });
  }
  ...
  async getRemainingSuperLikes(@Headers('authorization') authorization: string) {
    return this.proxyService.get('matchingService', '/api/super-likes/quota', {
      Authorization: authorization,
    });
  }
  ...
  async activateBoost(@Headers('authorization') authorization: string) {
    return this.proxyService.post('matchingService', '/api/boosts/activate', {}, {
      Authorization: authorization,
    });
  }
  ...
  async getBoostStatus(@Headers('authorization') authorization: string) {
    return this.proxyService.get('matchingService', '/api/boosts/active', {
      Authorization: authorization,
    });
  }
