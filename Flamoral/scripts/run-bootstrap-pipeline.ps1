...
$pipelineId = 17  # Bootstrap pipeline ID

Write-Host "=== Running Bootstrap Pipeline ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "Bootstrap pipeline run queued!" -ForegroundColor Green
