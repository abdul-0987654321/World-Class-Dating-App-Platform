/**
 * NestJS entry point for analytics-service
 *
...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Flamoral Analytics Service API')
    .setDescription('Analytics and metrics tracking service for Flamoral')
    .setVersion('1.0')
    .addBearerAuth(
      {
        type: 'http',
    ...
    .addTag('metrics', 'Metrics and reporting endpoints')
