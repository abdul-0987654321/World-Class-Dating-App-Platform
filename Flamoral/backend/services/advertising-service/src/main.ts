/**
 * NestJS entry point for advertising-service
 *
...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Flamoral Advertising Service API')
    .setDescription('Advertising and promotion management service for Flamoral')
    .setVersion('1.0')
    .addBearerAuth(
      {
        type: 'http',
    ...
    .addTag('advertising', 'Advertising management endpoints')
  ...
  console.log(`🚀 Advertising Service running on: http://localhost:${port}`);
