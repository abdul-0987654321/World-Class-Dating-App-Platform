/**
 * NestJS entry point for notification-service
 *
...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Flamoral Notification Service API')
    .setDescription('Push notifications, email, and SMS service for Flamoral')
    .setVersion('1.0')
    .addBearerAuth(
      {
        type: 'http',
