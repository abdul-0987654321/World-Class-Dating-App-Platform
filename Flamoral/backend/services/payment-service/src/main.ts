/**
 * NestJS entry point for payment-service
 *
...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Flamoral Payment Service API')
    .setDescription('Payment processing and subscription management service for Flamoral')
    .setVersion('1.0')
    .addBearerAuth(
      {
        type: 'http',
