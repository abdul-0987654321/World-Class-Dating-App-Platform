...
export class SecurityHeadersMiddleware implements NestMiddleware {
  ...
  constructor(private readonly configService: ConfigService) {
    ...
    this.cspReportUri = this.configService.get<string>('CSP_REPORT_URI') || '/api/security/csp-report';
  ...
  private buildCSPDirectives(): string {
    const directives = {
      ...
      'script-src': this.isDevelopment
        ? ["'self'", "'unsafe-inline'", "'unsafe-eval'", 'https://js.stripe.com', 'https://www.google-analytics.com', 'https://www.googletagmanager.com'] // Allow inline scripts in dev for HMR
        : ["'self'", 'https://js.stripe.com', 'https://www.google-analytics.com', 'https://www.googletagmanager.com'], // Allow trusted third-party scripts
