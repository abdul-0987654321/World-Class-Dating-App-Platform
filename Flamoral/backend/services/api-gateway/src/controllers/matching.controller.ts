...
export class MatchingController {
   ...
   */
  @Get('likes/received')
  @ApiOperation({ summary: 'Get users who liked me (requires BASIC+)' })
  ...
  /**
   * Get match count
   * NOTE: Must be BEFORE matches/:matchId to avoid route conflict
   */
  @Get('matches/count')
   ...
   * NOTE: Must be AFTER specific routes like matches/count to avoid conflicts
   */
  @Get('matches/:matchId')
