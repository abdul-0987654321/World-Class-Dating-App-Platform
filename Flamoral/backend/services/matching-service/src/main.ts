/**
 * NestJS entry point for matching-service
 *
...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Flamoral Matching Service API')
    .setDescription('Matching algorithm and discovery service for Flamoral')
    .setVersion('1.0')
    .addBearerAuth(
      {
        type: 'http',
    ...
    .addTag('matching', 'Matching algorithm endpoints')
    .addTag('discovery', 'Profile discovery endpoints')
