...
import photoVerificationRoutes from './api/routes/photo-verification.routes';
...
import videoChatRoutes from './api/routes/video-chat.routes';
...
// Dashboard and video chat routes
