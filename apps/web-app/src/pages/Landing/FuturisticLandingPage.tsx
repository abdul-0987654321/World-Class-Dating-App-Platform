...
const FuturisticLandingPage: React.FC = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      quote: 'Our 94% compatibility score was spot on. The AI really understood what we were looking for. We connected immediately and haven not looked back.',
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-4xl font-bold text-white mb-6">$0<span className="text-lg font-normal text-gray-500">/mo</span></p>
              ...
              <Link to="/signup" className="block w-full text-center border-2 border-pink-500 text-pink-400 py-3 rounded-full font-semibold hover:bg-pink-500/10 transition-all duration-300">
                Get Started
              </Link>
            </motion.div>
            ...
            >
              ...
              <p className="text-4xl font-bold text-white mb-6">$19.99<span className="text-lg font-normal text-pink-100">/mo</span></p>
              <ul className="space-y-3 mb-8">
              ...
              <Link to="/signup" className="block w-full text-center bg-white text-pink-500 py-3 rounded-full font-semibold hover:shadow-lg transition-all duration-300">
                Start Free Trial
              </Link>
            </motion.div>
            ...
            >
              ...
              <p className="text-4xl font-bold text-white mb-6">$34.99<span className="text-lg font-normal text-gray-500">/mo</span></p>
              <ul className="space-y-3 mb-8">
