          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-800">
                A confirmation email has been sent to your registered email address with your ticket
                number.
              </p>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Include relevant details like error messages, device info, or steps to reproduce the
                issue.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                <label htmlFor="file-upload" className="cursor-pointer">
                  ...
                  <p className="text-xs text-gray-500">PNG, JPG, PDF up to 10MB (max 5 files)</p>
                </label>
              </div>
