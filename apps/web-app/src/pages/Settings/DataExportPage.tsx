        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="p-6 border-b">
            ...
            <p className="text-gray-600">
              Request a copy of your personal data stored on Flamoral. We'll compile it into a
              downloadable file.
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800">
                  Under GDPR and other data protection laws, you have the right to access, download,
                  and delete your personal data. This process typically takes 1-3 business days to
                  complete.
                </p>
              </div>
            </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3">
                    {exportRequest.status === 'ready' ? (
                      ...
                      <svg
                        className="w-6 h-6 text-blue-500 flex-shrink-0 animate-spin"
                        fill="none"
                        viewBox="0 0 24 24"
                      >
                        <circle
              ...
              <div className="space-y-3">
                {Object.entries({
                  profile: {
                    ...
                    desc: 'Name, bio, preferences, and settings',
                  },
                  ...
                  likes: {
                    ...
                    desc: 'People you liked and who liked you',
                  },
          ...
          <div className="p-6 bg-gray-50 border-t">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-gray-600">
                ...
                <p>
                  The download link will be sent to your registered email and is protected by secure
                  authentication. Keep this link private and don't share it with others.
                </p>
              </div>
            </div>
          </div>
