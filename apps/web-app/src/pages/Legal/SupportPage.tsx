      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-300">
                Go to Settings → Account → Delete Account. Please note this action is permanent and
                cannot be undone.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-300">
                Go to Safety Center → Verification. You can verify your profile by uploading a
                selfie or linking your social media accounts.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-300">
                Open the user's profile, tap the three dots menu, and select "Report". Choose the
                reason for your report and submit.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-300">
                Go to Settings → Subscription → Manage Subscription. You can cancel your
                subscription at any time, and you'll retain access until the end of your billing
                period.
              </p>
            </div>
          </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 mb-12">
          ...
          <p className="text-gray-300 mb-4">
            Your safety is our top priority. Here are some helpful resources:
          </p>
          <ul className="space-y-2">
            <li>
              <Link to="/safety-guidelines" className="text-pink-400 hover:text-pink-300">
                Safety Guidelines
              </Link>
            </li>
            <li>
              <Link to="/community-guidelines" className="text-pink-400 hover:text-pink-300">
                Community Guidelines
              </Link>
            </li>
            <li>
              <Link to="/privacy-policy" className="text-pink-400 hover:text-pink-300">
                Privacy Policy
              </Link>
            </li>
            <li>
              <Link to="/terms-of-service" className="text-pink-400 hover:text-pink-300">
                Terms of Service
              </Link>
            </li>
          </ul>
