        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <section className="mb-8">
            <p className="text-gray-700 leading-relaxed">
              Welcome to Flamoral! We're building a community where everyone can find meaningful
              connections in a safe, respectful environment. These guidelines help ensure our
              platform remains a positive space for all users.
            </p>
          </section>
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-4 border-pink-500 pl-4">
                ...
                <p className="text-gray-700 mb-2">
                  Treat everyone on Flamoral with respect, regardless of their background, beliefs,
                  or preferences.
                </p>
              ...
              <div className="border-l-4 border-purple-500 pl-4">
                ...
                <p className="text-gray-700 mb-2">
                  Keep Flamoral a comfortable space for everyone.
                </p>
                <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
          ...
          <section className="mb-8">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-6">
              <p className="text-gray-700 mb-4">
                The following behaviors are strictly prohibited and may result in immediate account
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">Violations of these guidelines may result in:</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              ...
              or platform. Continued use of Flamoral after updates constitutes acceptance of the new
          ...
          <section className="bg-gradient-to-r from-pink-500 to-purple-600 rounded-xl p-6 text-white">
            ...
            <p className="mb-4 opacity-90">
              If you have questions about these guidelines or need to report a serious issue, please
