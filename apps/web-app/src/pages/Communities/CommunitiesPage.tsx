...
export const CommunitiesPage: React.FC = () => {
  ...
  const getDefaultEvents = (): Event[] => [
    {
      ...
      description: 'Meet fellow travelers in Central Park',
    ...
    },
    {
      ...
      description: 'Explore the best eateries in Brooklyn',
  ...
  const getDefaultPosts = (): Post[] => [
    ...
    },
    {
      ...
      content:
        'Morning hike at sunrise. Best way to start the weekend! Who wants to join next time?',
      likes: 67,
      comments: 15,
        ...
        <main className="max-w-6xl mx-auto px-4 py-6">
          ...
          <div className="bg-white rounded-xl p-1 flex mb-6 shadow-sm">
            {(['discover', 'joined', 'events'] as const).map((tab) => (
              ...
              >
                {tab === 'joined'
                  ? `My Communities (${communities.filter((c) => c.isJoined).length})`
                  : tab}
              </button>
            ))}
          </div>
              ...
              {activeTab === 'discover' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {communities.map((community) => (
                    ...
                    >
                      <div
                        className={`w-16 h-16 rounded-xl bg-gradient-to-r ${community.color} flex items-center justify-center mb-4`}
                      >
                  ...
                  {communities.filter((c) => c.isJoined).length === 0 ? (
                    ...
                    communities
                      ...
                      .map((community) => (
                        ...
                        >
                          <div
                            className={`w-12 h-12 rounded-lg bg-gradient-to-r ${community.color} flex items-center justify-center`}
                          >
