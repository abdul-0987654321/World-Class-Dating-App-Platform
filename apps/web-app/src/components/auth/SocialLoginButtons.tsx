  ...
  return (
    <div className="w-full mt-5">
      <div className="relative flex items-center justify-center my-4 sm:my-5">
        ...
        ></div>
        <span className="px-3 sm:px-4 text-xs sm:text-sm text-gray-400">Or continue with</span>
        <div
          className="flex-grow"
          style={{ height: '1px', background: 'rgba(139, 92, 246, 0.3)' }}
        ></div>
      ...
      <div className="flex justify-center gap-3 sm:gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105 sm:hover:scale-110"
          style={{
