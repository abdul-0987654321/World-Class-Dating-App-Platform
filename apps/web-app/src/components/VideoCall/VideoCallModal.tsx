            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                ...
                {callState.status === 'connected' && (
                  <div
                    className={`mt-4 flex items-center justify-center gap-2 ${networkQuality.color}`}
                  >
                    <svg viewBox="0 0 24 24" className="w-5 h-5">
                      <path
                        fill="currentColor"
                        d="M1 9l2 2c4.97-4.97 13.03-4.97 18 0l2-2C16.93 2.93 7.08 2.93 1 9zm8 8l3 3 3-3c-1.65-1.66-4.34-1.66-6 0zm-4-4l2 2c2.76-2.76 7.24-2.76 10 0l2-2c-3.87-3.87-10.14-3.87-14 0z"
                      />
                    </svg>
            ...
            >
              <div className="flex justify-center gap-4 md:gap-6">
                ...
                >
                  ...
                  <span className="text-white text-sm mt-2">{isMuted ? 'Unmute' : 'Mute'}</span>
                </motion.button>
          ...
          >
            <div className="text-center">
              ...
              {callState.duration > 0 && (
                <p className="text-gray-400 mb-6">Duration: {formatDuration(callState.duration)}</p>
              )}
              {callState.error && <p className="text-red-400 text-sm mb-6">{callState.error}</p>}
            </div>
          </motion.div>
        )}
      </motion.div>
