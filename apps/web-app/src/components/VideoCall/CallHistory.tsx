  ...
  const getCallIcon = (call: CallHistoryItem) => {
    ...
    if (call.callType === 'video') {
      return (
        <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
          ...
          <svg viewBox="0 0 24 24" className={`w-5 h-5 ${isMissed ? 'text-red-500' : 'text-blue-500'}`}>
    ...
    return (
      <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
        ...
        <svg viewBox="0 0 24 24" className={`w-5 h-5 ${isMissed ? 'text-red-500' : 'text-green-500'}`}>
          {isIncoming ? (
              ...
              {dateCalls.map((call, index) => (
                ...
                >
                  <div
                    ...
                    onClick={() => setSelectedCall(selectedCall === call.callId ? null : call.callId)}
                  >
                    {/* Avatar */}
                      ...
                      >
                        <div className="px-4 py-3 flex items-center justify-between">
                          <div className="flex gap-4">
                            <button
                              onClick={() => onCallBack(call.participantId, call.participantName, 'video')}
                            ...
                            <button
                              onClick={() => onCallBack(call.participantId, call.participantName, 'audio')}
