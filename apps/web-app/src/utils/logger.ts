/**
 * Secure, Environment-Aware Logger for Web Application
 *
 * Features:
...
class Logger {
  ...
  private sanitizeUrl(url: string): string {
    try {
      ...
      const sensitiveParams = ['token', 'access_token', 'refresh_token', 'api_key', 'key', 'session'];
