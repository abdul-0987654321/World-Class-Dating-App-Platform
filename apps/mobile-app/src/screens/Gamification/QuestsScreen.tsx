...
const QuestsScreen: React.FC = () => {
  ...
  const renderQuest = (quest: Quest) => {
    ...
    return (
      <View
        ...
        style={[
          styles.questCard,
          isComplete && styles.questCardComplete,
          quest.isClaimed && styles.questCardClaimed,
        ]}
      >
          ...
          <View style={styles.questProgressBar}>
            <View
              style={[
                ...
                isComplete && styles.questProgressFillComplete,
              ]}
            />
          </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.questsList}>{quests.map(renderQuest)}</View>
      </ScrollView>
    </SafeAreaView>
  );
};
