              ...
              <View style={styles.levelProgressBar}>
                <View
                  style={[
                    ...
                    { width: `${(dashboard.level.xpProgress / dashboard.level.xpNeeded) * 100}%` },
                  ]}
                />
              </View>
              ...
              >
                {claimingReward ? (
                  ...
                  <Text style={styles.claimDailyButtonText}>
                    {dashboard.dailyRewards.canClaim ? 'Claim Daily' : 'Claimed!'}
                  </Text>
                )}
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.streakLeft}>
              ...
              <View style={styles.streakInfo}>
                <Text style={styles.streakCount}>
                  {dashboard.streaks.login.currentStreak} Day Streak!
                </Text>
                <Text style={styles.streakBest}>
                  Best: {dashboard.streaks.login.longestStreak} days
                </Text>
              </View>
            </View>
