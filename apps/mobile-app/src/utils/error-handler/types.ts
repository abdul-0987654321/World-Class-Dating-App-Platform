...
/**
 * Error handler configuration for React Native
 */
export interface ErrorHandlerConfig {
  /** Callback for redirecting to login screen */
  onAuthRequired?: () => void;
  /** Callback for redirecting to billing/upgrade screen */
  onBillingRequired?: () => void;
  /** Callback for showing not found screen */
  onNotFound?: () => void;
  /** Callback for showing maintenance screen */
  onMaintenance?: () => void;
  /** Callback for showing alert/toast notifications */
...
/**
 * Error boundary props for React Native
 */
...
/**
 * API client request options for React Native
 */
...
/**
 * API client configuration for React Native
 */
