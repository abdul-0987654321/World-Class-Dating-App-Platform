...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  [AuthErrorCode.AUTH_ACCOUNT_LOCKED_PERMANENT]:
  ...
  [PlatformErrorCode.DEPLOYMENT_IN_PROGRESS]:
    'We are updating our systems. Please try again shortly.',
  ...
  [MatchingErrorCode.SWIPE_LIMIT_REACHED]:
  ...
  [MatchingErrorCode.MESSAGE_TOO_SHORT]:
  ...
  [MatchingErrorCode.DELETE_WINDOW_EXPIRED]:
  ...
  [MatchingErrorCode.REMATCH_NOT_ALLOWED]:
    'Rematch is a Premium feature. Upgrade to rematch with expired matches.',
  [MatchingErrorCode.REWIND_NOT_ALLOWED]:
    'Rewind is not available for your subscription tier. Upgrade to unlock this feature.',
  [MatchingErrorCode.REWIND_LIMIT_REACHED]:
    'You have reached your daily rewind limit. Upgrade for more rewinds or try again tomorrow.',
  [MatchingErrorCode.NO_SWIPE_TO_REWIND]: 'No recent swipes available to rewind.',
  [MatchingErrorCode.REWIND_WINDOW_EXPIRED]:
    'This swipe can no longer be rewound. Swipes can only be rewound within 3 hours.',
};
