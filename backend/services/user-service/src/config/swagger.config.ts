...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description:
        'User authentication, profile management, email verification, and password reset service for Flamoral dating platform',
      contact: {
      ...
      schemas: {
        ...
        CoinTransaction: {
          ...
          properties: {
            ...
            type: {
              type: 'string',
              enum: ['purchase', 'spent', 'reward', 'refund', 'admin_adjustment'],
              example: 'purchase',
            },
