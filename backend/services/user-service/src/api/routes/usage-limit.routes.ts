...
router.get(
  '/check/:resourceType',
  authenticate,
  validate(resourceTypeParamsSchema, 'params'),
  usageLimitController.checkLimit.bind(usageLimitController)
);
router.get(
  '/usage/:resourceType',
  authenticate,
  validate(resourceTypeParamsSchema, 'params'),
  usageLimitController.getResourceUsage.bind(usageLimitController)
);
