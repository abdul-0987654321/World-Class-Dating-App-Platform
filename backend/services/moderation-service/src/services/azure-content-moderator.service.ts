/**
 * BACKWARD COMPATIBILITY: Text Moderation Service using AWS Comprehend
 * This file replaces Azure Content Moderator with AWS Comprehend for text moderation.
 * Named azure-content-moderator.service.ts for backward compatibility during migration.
 */
