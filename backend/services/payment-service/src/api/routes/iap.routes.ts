...
import { validateBody, ValidateReceiptDto, RestorePurchasesDto } from '../../dto';
...
router.get('/subscription', iapController.getSubscriptionStatus.bind(iapController));

// Get transaction history
router.get('/transactions', iapController.getTransactionHistory.bind(iapController));

// Get wallet balance
router.get('/wallet', iapController.getWallet.bind(iapController));
