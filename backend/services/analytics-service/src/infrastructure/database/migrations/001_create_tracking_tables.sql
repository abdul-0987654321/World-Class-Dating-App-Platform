...
CREATE TABLE IF NOT EXISTS user_attribution (
  ...
  CONSTRAINT fk_user_attribution FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS pixel_events (
  ...
  CONSTRAINT fk_pixel_event_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL
);
