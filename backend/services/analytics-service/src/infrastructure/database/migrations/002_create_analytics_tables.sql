...
CREATE TABLE IF NOT EXISTS swipe_events (
  ...
  CONSTRAINT fk_swipe_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
  CONSTRAINT fk_swipe_target_user FOREIGN KEY (target_user_id) REFERENCES users(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS match_events (
  ...
  CONSTRAINT fk_match_user_1 FOREIGN KEY (user_id_1) REFERENCES users(id) ON DELETE CASCADE,
  CONSTRAINT fk_match_user_2 FOREIGN KEY (user_id_2) REFERENCES users(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS date_arrangements (
  ...
  CONSTRAINT fk_date_user_1 FOREIGN KEY (user_id_1) REFERENCES users(id) ON DELETE CASCADE,
  CONSTRAINT fk_date_user_2 FOREIGN KEY (user_id_2) REFERENCES users(id) ON DELETE CASCADE
);
