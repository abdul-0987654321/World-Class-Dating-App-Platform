 ...
 */
router.post('/photo/:mediaId', authenticate, async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/profile/:mediaId', authenticate, async (req: Request, res: Response) => {
  try {
    const { mediaId } = req.params;
 ...
 */
router.post('/comprehensive/:mediaId', authenticate, async (req: Request, res: Response) => {
  try {
    const { mediaId } = req.params;
 ...
 */
router.get('/status/:mediaId', authenticate, async (req: Request, res: Response) => {
  try {
    const { mediaId } = req.params;
 ...
 */
router.post('/queue/:mediaId', authenticate, async (req: Request, res: Response) => {
  try {
    const { mediaId } = req.params;
    const { userId, imageUrl, referencePhotoUrl } = req.body;
    ...
    await photoVerificationService.queueVerification(mediaId, userId, imageUrl, referencePhotoUrl);
 ...
 */
router.post('/liveness', authenticate, async (req: Request, res: Response) => {
  try {
    const { imageUrl } = req.body;
 ...
 */
router.post('/check-duplicate', authenticate, async (req: Request, res: Response) => {
  try {
    ...
    const result = await photoVerificationService.detectDuplicateProfile(userId, faceId);
 ...
 */
router.post('/stock-photo', authenticate, async (req: Request, res: Response) => {
  try {
    const { imageUrl } = req.body;
