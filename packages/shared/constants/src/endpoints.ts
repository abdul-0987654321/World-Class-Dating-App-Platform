/**
 * Unified API Endpoints for Flamoral Dating App
 *
 * This file provides standardized API paths that both web and mobile apps should use.
 * All paths follow the pattern: /api/v1/{service}/{resource}
 *
 * Services:
 * - auth: Authentication and session management
 * - users: User account operations
 * - profiles: User profile management
 * - matches: Match-related operations
 * - messages: Messaging and conversations
 * - notifications: Push notifications and alerts
 * - subscriptions: Subscription and billing
 * - coins: Virtual currency operations
 * - discovery: Profile discovery and recommendations
...
/**
 * Type definitions for endpoint objects
 */
