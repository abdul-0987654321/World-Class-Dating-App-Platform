################################################################################
# Staging Environment Configuration - ECS Fargate
...
module "networking" {
  ...
  enable_nat_gateway   = true # NAT already exists in shared VPC
  single_nat_gateway   = true
  enable_flow_logs     = true # Flow logs already configured
  enable_vpc_endpoints = true # VPC endpoints already exist
