...
################################################################################
        {
          type   = "metric"
          x      = 0
          y      = var.eks_cluster_name != null ? 15 : 2
          width  = 6
          height = 6
          properties = {
            title   = "CPU Utilization"
        ...
        },
        {
          type   = "metric"
          x      = 0
          y      = var.eks_cluster_name != null ? 21 : 8
          width  = 6
          height = 6
          properties = {
            title   = "Read/Write IOPS"
      ...
      var.elasticache_cluster_id != null ? [
        {
          type   = "text"
          x      = 0
          y      = (var.eks_cluster_name != null ? 14 : 1) + (var.rds_cluster_id != null ? 14 : 0)
          width  = 24
          height = 1
          properties = {
            markdown   = "## ElastiCache Redis Metrics"
        ...
        },
        {
          type   = "metric"
          x      = 0
          y      = (var.eks_cluster_name != null ? 15 : 2) + (var.rds_cluster_id != null ? 14 : 0)
          width  = 6
          height = 6
          properties = {
            title   = "CPU Utilization"
        ...
        },
        {
          type   = "metric"
          x      = 0
          y      = (var.eks_cluster_name != null ? 21 : 8) + (var.rds_cluster_id != null ? 14 : 0)
          width  = 6
          height = 6
          properties = {
            title   = "Cache Hits/Misses"
...
resource "aws_cloudwatch_dashboard" "api_performance" {
  ...
  dashboard_body = jsonencode({
    widgets = concat(
      ...
      var.alb_arn_suffix != null ? [
        ...
        },
        {
          ...
          properties = {
            ...
            metrics = [
              [{
                expression = "(m1+m2)/(m3+0.0001)*100"
                label      = "Error Rate %"
                id         = "e1"
                color      = "#ff0000"
              }],
      ...
      # API Gateway Section (if using API Gateway)
      var.api_gateway_id != null ? [
        {
          type   = "text"
          x      = 0
          y      = var.alb_arn_suffix != null ? 20 : 1
          width  = 24
          height = 1
          properties = {
            markdown   = "## API Gateway Metrics"
        ...
        },
        {
          type   = "metric"
          x      = 0
          y      = var.alb_arn_suffix != null ? 21 : 2
          width  = 8
          height = 6
          properties = {
            title   = "API Requests"
      ...
      [
        {
          type   = "text"
          x      = 0
          y      = (var.alb_arn_suffix != null ? 20 : 1) + (var.api_gateway_id != null ? 8 : 0)
          width  = 24
          height = 1
          properties = {
            markdown   = "## Application Performance Metrics"
        ...
        },
        {
          type   = "metric"
          x      = 0
          y      = (var.alb_arn_suffix != null ? 21 : 2) + (var.api_gateway_id != null ? 8 : 0)
          width  = 8
          height = 6
          properties = {
            title   = "API Endpoint Latency by Service"
